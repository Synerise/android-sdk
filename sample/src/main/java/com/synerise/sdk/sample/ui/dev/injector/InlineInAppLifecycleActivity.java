...
public class InlineInAppLifecycleActivity extends BaseActivity {

    private static final String PLACEMENT_KEY = "lifecycle";
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, InlineInAppLifecycleActivity.class);
    }

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_inline_inapp_lifecycle);
        ToolbarHelper.setUpChildToolbar(this, R.string.inline_inapp_lifecycle);
