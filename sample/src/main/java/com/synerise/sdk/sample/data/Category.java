...
public enum Category {
    ...
    HOUSEHOLD_GOODS(R.color.turquoise,
                    ...
                    createProducts(Product.ELECTROLUX_OVEN, Product.ELECTROLUX_VACUUM, Product.COFFEE_MACHINE,
    ...
    MUSIC(R.color.amaranth,
          ...
          R.string.music,
          createProducts(Product.SABBATH_BLOODY_SABBATH, Product.KANSAS_LEFTOVERTURE, Product.ABOVE_AND_BEYOND_COMMON_GROUND,
                         Product.ELLIE_GOULDING_HALCYON)),
    BOOKS(R.color.lipstick,
          R.drawable.banner_books,
          R.string.books,
          createProducts(Product.STEENA_HOLMES_THE_FORGOTTEN_ONES_A_NOVEL, Product.CATHERINE_MCKENZIE_THE_GOOD_LIAR,
                         Product.CATHERINE_MCKENZIE_HIDDEN, Product.JRR_TOLKIEN_THE_SILMARILLION)),
    ...
    public static Category getCategory(Product product) {
        for (Category category : Category.values()) {
            for (Product categoryProduct : category.products) {
