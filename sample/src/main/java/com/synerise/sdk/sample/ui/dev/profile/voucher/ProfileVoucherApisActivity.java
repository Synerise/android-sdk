package com.synerise.sdk.sample.ui.dev.profile.voucher;
...
public class ProfileVoucherApisActivity extends BaseActivity {

    public static Intent createIntent(Context context) {
        return new Intent(context, ProfileVoucherApisActivity.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ApiRecyclerAdapter adapter = new ApiRecyclerAdapter(LayoutInflater.from(this),
                                                            ...
                                                            SyneriseSdkApi.getProfileVoucherApis());
