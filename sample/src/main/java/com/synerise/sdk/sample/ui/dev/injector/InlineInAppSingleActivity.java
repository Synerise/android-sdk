...
public class InlineInAppSingleActivity extends BaseActivity {
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, InlineInAppSingleActivity.class);
    }

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_inline_inapp_single);
        ToolbarHelper.setUpChildToolbar(this, R.string.inline_inapp_single);
