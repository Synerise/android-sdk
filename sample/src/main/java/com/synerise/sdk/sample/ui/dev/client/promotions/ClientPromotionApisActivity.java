package com.synerise.sdk.sample.ui.dev.client.promotions;
...
public class ClientPromotionApisActivity extends BaseActivity {

    public static Intent createIntent(Context context) {
        return new Intent(context, ClientPromotionApisActivity.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ApiRecyclerAdapter adapter = new ApiRecyclerAdapter(LayoutInflater.from(this),
                                                            ...
                                                            SyneriseSdkApi.getClientPromotionApis());
