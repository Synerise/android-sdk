...
public class ProfileGetOrAssignVoucherFragment extends BaseDevFragment {

    private TextInputLayout inputPool;
    private IDataApiCall<AssignVoucherResponse> call;

    public static ProfileGetOrAssignVoucherFragment newInstance() { return new ProfileGetOrAssignVoucherFragment(); }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_profile_get_or_assign_voucher, container, false);
    }
